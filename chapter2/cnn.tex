...
\subsection*{Activation function\textsuperscript{\cite{activation}}}
...
เป็นชั้นที่จะรวมคุณลักษณะทั้งหมดของชั้นก่อนหน้าให้เป็นเวกเตอร์ ก่อนที่จะนำเวกเตอร์ที่ได้ไปคำนวณด้วย activation function เพื่อหาคำตอบสำหรับการแยกหมวดหมู่ของภาพ
ซึ่งฟังก์ชั่นที่นิยมใช้จะมีสองฟังก์ชั่น คือ softmax และ sigmoid (logistic) โดยทั้งสองมีความแตกต่างกันดังตารางที่ \ref{tab:softmax_vs_sigmoid}
\begin{table}[!ht]
	\centering
	\begin{tabular}{|c|c|c|}
		\hline
...
Non Maximum Suppression\textsuperscript{\cite{nms}} คือ อัลกอริทึ่มที่นิยมใช้เข้ามาช่วยจัดการปัญหากรอบสี่เหลี่ยมที่ซ้อนทับกันซึ่งเกิดจากการทำนายซ้ำ เพื่อให้ได้กรอบสี่เหลี่ยมที่บ่งบอกถึงตำแหน่งของวัตถุนั้นเพียงกรอบเดียว 
\begin{figure}[!ht]
	\centering
