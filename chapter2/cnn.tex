...
\begin{enumerate}
	...
	\end{figure} 
	\item RMS Prop หรือ root-mean-square propagation ซึ่งมีความคล้ายคลึงกับ Momentum หากดูจากรูปที่ \ref{fig:momentum_explain} กำหนดให้แกน y เป็นเมทริกซ์ค่าอคติ แกน x คือ weight
	และเส้นสีเขียวเป็นของ RMS Prop ในขณะที่ momentum ใช้ค่าเฉลี่ยเคลื่อนที่ในการลดการแกว่งในแนวแกน y RMS Prop จะใช้ค่าเฉลี่ยรากที่สองของเมทริกซ์กำลังสองมาหารเพื่อลดการแกว่งในแกน y ซึ่งทำให้ต้องมีค่าคงที่ $\epsilon$
	เพื่อไม่ให้เกิดเหตุการณ์หารด้วยศูนย์ ซึ่งสมการปรับ weight และเมทริกซ์ค่าอคติจะเป็นดังนี้
	\begin{equation}
	...
	\end{equation}
	ซึ่ง $S_{dW}$ และ $S_{db}$ สามารถหาได้จากสมการที่ \ref{equa:s_w} และ \ref{equa:s_b} ตามลำดับ
	\begin{equation}
	...
	โดยที่
	\begin{conditions}
		S_{dW}		&	ค่าเฉลี่ยรากที่สองของอนุพันธ์ของเมทริกซ์ weight \\
		S_{db}		&	ค่าเฉลี่ยรากที่สองของอนุพันธ์ของเมทริกซ์ค่าอคติกำลังสอง\\
		\beta		&	พารามิเตอร์ของสมการค่าเฉลี่ยรากที่สองของอนุพันธ์\\
