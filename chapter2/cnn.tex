...
\begin{enumerate}
	...
	โดยที่
	\begin{conditions}
		S_{dW}		&	ค่าเฉลี่ยกำลังสองของอนุพันธ์ของเมทริกซ์ weight \\
		S_{db}		&	ค่าเฉลี่ยกำลังสองของอนุพันธ์ของเมทริกซ์ค่าอคติ\\
		\beta		&	พารามิเตอร์ของสมการค่าเฉลี่ยกำลังสองของอนุพันธ์\\
